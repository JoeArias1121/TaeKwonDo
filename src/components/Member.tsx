export default function Member({
  ...
  return (
    <div className="group flex flex-col items-center bg-card border rounded-3xl p-6 shadow-sm hover:shadow-lg hover:border-primary/30 transition-all duration-300 w-full max-w-[280px]">
      ...
      <h3 className="text-lg font-heading font-bold text-center mt-2 group-hover:text-primary transition-colors">
        {name}
      </h3>
      <span className="text-sm font-medium text-muted-foreground uppercase tracking-wider mt-1 text-center">
        {rank}
      </span>
    </div>
  );
